  ...
  <body>
    <form action="update.php" method="POST" id="msform">
      ...
      <fieldset>
        ...
        <p><label>Product Image<input type="text" name="product_image" value="<?php echo $row['product_image']?>"></label></p>
        <p><label>Product Image<input type="text" name="decs" value="<?php echo $row['decs']?>"></label></p>
